...
type Payload struct {
	...
	BeginRegisterPayload    RegisterPayload         `json:"register_payload,omitempty"`
...
func (app *application) Gateway(w http.ResponseWriter, r *http.Request) {
	...
	case "begin-register":
		app.HandleBeginRegisterRoute(w, r, payload.BeginRegisterPayload)
	case "complete-register":
		fmt.Print(payload.CompleteRegisterPayload)
		app.HandleCompleteRegister(w, r, payload.CompleteRegisterPayload)
	}

}

func (app *application) HandleBeginRegisterRoute(w http.ResponseWriter, r *http.Request, payload RegisterPayload) {
